...
[task_local]
#汪汪乐园养joy
25 0-23/3 * * * jd_joypark_joy.js, tag=汪汪乐园养joy, img-url=https://raw.githubusercontent.com/tsukasa007/icon/master/jd_joypark_joy.png, enabled=true

================Loon==============
[Script]
cron "25 0-23/3 * * *" script-path=jd_joypark_joy.js,tag=汪汪乐园养joy

===============Surge=================
汪汪乐园养joy = type=cron,cronexp="25 0-23/3 * * *",wake-system=1,timeout=3600,script-path=jd_joypark_joy.js

============小火箭=========
汪汪乐园养joy = type=cron,script-path=jd_joypark_joy.js, cronexpr="25 0-23/3 * * *", timeout=3600, enable=true
*/
